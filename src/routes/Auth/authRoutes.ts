    ...
    jwt({
      ...
      .post(
        ...
        },
        {
          ...
          detail: {
            tags: ['Auth'],
            summary: 'Inscription',
            description: 'Permet de créer un nouveau compte utilisateur avec le rôle "User" par défaut'
          }
        }
      )
      ...
      // deconnexion
        ...
        },
        {
          ...
          detail: {
            tags: ['Auth'],
            summary: 'Deconnexion',
            description: 'Permet de se déconnecter de l\'application'
          }
        }
      )
      ...
      authRoutes.put(
        ...
        },
        {
          ...
          detail: {
            ...
            description: 'Permet de changer le mot de passe de l\'utilisateur'
          }
        }
      )
      ...
      .get(
        ...
        },
        {
          ...
          detail: {
            ...
            description: 'Permet de récupérer les informations de l\'utilisateur connecté'
          }
        }
      )
      ...
      },
      {
        ...
        detail: {
          ...
          description: 'Permet de supprimer le compte utilisateur'
        }
      }
      ...
      authRoutes.post(
        ...
        },
        {
          ...
          detail: {
            ...
            description: 'Permet de réinitialiser le mot de passe en envoyant un e-mail'
          }
        }
      )
      ...
      authRoutes.post(
        ...
        },
        {
          ...
          detail: {
            ...
            description: 'Permet de réinitialiser le mot de passe avec un token'
          }
        }
      )
      // ---------------------------------------------------------------------------------------------------------------------------------------
      ...
      .post(
        ...
        },
        {
          ...
          detail: {
            tags: ['Role'],
            summary: 'Attribution de permission',
            description: 'Permet d\'attribuer une permission à un rôle'
          }
        }
      )
      ...
      .get(
        ...
        },
        {
          ...
          detail: {
            ...
            description: 'Permet de récupérer la liste de tous les rôles'
          }
        }
      )
      ...
      .get(
        ...
        },
        {
          ...
          detail: {
            ...
            description: 'Permet de récupérer les permissions d\'un rôle spécifique'
          }
        }
      )
      ...
      authRoutes.put(
        ...
        },
        {
          ...
          detail: {
            tags: ['Role'],
            summary: 'mise a jour role',
            description: 'mettre a jour un rôle'
          }
        }
      )
        ...
        .put(
          ...
          },
          {
            ...
            detail: {
              ...
              description: 'Permet de mettre à jour le statut d\'un utilisateur (actif/inactif)'
            }
          }
        )
